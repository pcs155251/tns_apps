...
fieldLoad  = 3.50
prefix     = 'su_b2'
wvLoadFoldStr = '-wvLoadFolder su_1e-2/'
saveFoldStr = '-saveFolder su_b2/'
#Dstart     = 14
#Dend       = 15 
#Ddelta     = 1
#ifload     = 0
...
def runFuTaiwania( field, fieldLoad ):
  ...
  scriptFile = scriptFolder + jobName + '_Taiwania.sh'
  scriptObj = open( scriptFile, 'w' )
  ...
  scriptObj.write('\n')
  scriptObj.write('./main.e inputSu.rc  -field %f -fieldLoad %f %s %s \n' %( field, fieldLoad, wvLoadFoldStr, saveFoldStr ))
  scriptObj.write('\n')
  print( scriptFile + ' has been generated' )
  scriptObj.close()
  os.system('cd ' + scriptFolder )
